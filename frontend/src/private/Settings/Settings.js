                ...
                <div className="row">
                    <div className="col-12">
                        <div className="card card-body border-0 shadow mb-4">
                            <h2 className="h5 md-4">General info</h2>
                                ...
                                <div className="row">
                                    <div className="col-sm-12 mb-3">
                                        <div className="form-group">
                                            ...
                                            <input ref={inputAccessKey} className="form-control" id="accessKey" type="text" placeholder="Enter the API Access Key" />
                                        </div>
                                    </div>
                                </div>
                                <div className="row">
                                ...
                                <div className="row">
                                    <div className="d-flex justify-content-between flex-wrap flex-md-nowrap">
                                        <div className="col-sm-3">
                                            <button className="btn btn-gray-800 mt-2 animate-up-2" type="button" onClick={onFormSubmit}>Save all</button>
                                        </div>
                                        {
                                            error ?
